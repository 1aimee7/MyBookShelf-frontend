...
const newArrivalsData = [
  ...
  { id: 1, title: "Don&apos;t Make Me Think", coverImage: "/books/dont-make-me-think.jpg" }, // apostrophe escaped
];
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-1/3 bg-red-400 text-white rounded-2xl p-6 lg:p-8 flex flex-col justify-between" style={{ minHeight: '220px' }}>
          <div>
            <h2 className="text-lg font-semibold mb-2">Today&apos,s Quote</h2>
