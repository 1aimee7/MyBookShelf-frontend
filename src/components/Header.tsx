...
const Header = () => {
  ...
  return (
    <header className="flex-shrink-0 flex justify-between items-center p-4 sm:p-6 border-b border-gray-200/50">
        ...
        {isFilterOpen && (
          <div className="absolute top-full left-0 mt-2 w-40 bg-white border rounded-lg shadow-xl z-20">
            {filterOptions.map(opt => (
              <a key={opt} href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={(e) => {
                e.preventDefault();
      ...
      <div className="flex items-center space-x-2 sm:space-x-4 ml-4">
        <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center text-sm bg-white border rounded-lg p-2 shadow-sm">
            <Clock size={16} className="mr-2 text-gray-500" /> 09:00 AM
            </div>
            <div className="flex items-center text-sm bg-white border rounded-lg p-2 shadow-sm">
            <Calendar size={16} className="mr-2 text-gray-500" /> 4-MAR-2023
            </div>
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center bg-white border rounded-lg p-2 cursor-pointer shadow-sm hover:bg-gray-100"
          >
